...
# plot the results.
plt.plot(enr, P, '*', label=r'$acs \; monte \; carlo$')
plt.plot(enr, Pe, label=r'$acs \; analytic$')
...
plt.figure()
plt.semilogy(enr, P, '*', label=r'$acs \; analytic$')
plt.semilogy(enr, Pe, label=r'$acs \; analytic$')
